...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%SincronizaCD30.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -skip:objectname='dirPath',absolutepath='D:\\Users\\arturo\.garcia\\AppData\\Local\\Temp\\WebSitePublish\\SincronizaCD30-1466341221\\obj\\Debug\\Package\\PackageTmp\\App_Data$' -skip:objectname='dirPath',absolutepath='Default\ Web\ Site/NucleoDF/U5kCfg/SincronizaCD30\\App_Data$'
) else (
